// ABOUTME: Agent top bar experiment - Gradient Glow Badge
// ABOUTME: Gradient glow effect on status dot for premium visual feedback when agent is working
...
export const metadata = {
  ...
  description: "Gradient glow effect on status dot for premium visual feedback when agent is working",
};
    ...
    <div class="space-y-4">
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        {/* ============================================
            ...
            ============================================ */}
        <div class="px-4 py-2 border-b border-border flex items-center gap-3 bg-surface-raised">
          <Show when={isWorking()}>
            <span
              class="w-2 h-2 rounded-full bg-gradient-to-r from-gradient-from to-gradient-to animate-pulse"
              style={{
                "box-shadow": "0 0 12px var(--theme-glow), 0 0 6px var(--theme-accent)",
              }}
            />
          </Show>
