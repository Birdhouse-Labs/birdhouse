// ABOUTME: Agent top bar experiment - Thick Bottom Border + Subtle Hover
// ABOUTME: Compact (py-1) with thick 4px pulsing gradient bottom border, 50% opacity hover
...
export const metadata = {
  id: "29",
  title: "Thick Bottom Border + Subtle Hover",
  description: "Compact (py-1) with thick 4px pulsing gradient bottom border, 50% opacity hover",
};
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          ...
          style={{
            ...
            // Thick 4px bottom border - always same height
