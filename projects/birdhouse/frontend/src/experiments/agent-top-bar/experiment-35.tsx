// ABOUTME: Agent top bar experiment - Inside Corner Crescents (Radial Gradient)
// ABOUTME: Radial gradient pseudo-elements create crescent fills at top inside corners
...
export const metadata = {
  id: "35",
  title: "Inside Corner Crescents (Radial Gradient)",
  description: "Radial gradient pseudo-elements create crescent fills at top inside corners",
};
  ...
  return (
    <div class="space-y-4">
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          class="corner-crescents px-4 py-1 flex items-center gap-3 hover-subtle-gradient brightness-track relative overflow-hidden group"
      ...
      <style>{`
        ...
        /* Crescent fillers for inside top corners */
        .corner-crescents::before,
        .corner-crescents::after {
          content: '';
          position: absolute;
          width: 6px;
          height: 6px;
        ...
        /* Top-left crescent */
        .corner-crescents.working::before {
          opacity: 1;
          top: 3px;
          left: 3px;
          background: radial-gradient(circle at bottom right, transparent 3px, var(--theme-accent) 3px);
          z-index: 0;
        }
        ...
        .corner-crescents.working::after {
          ...
          top: 3px;
          right: 3px;
          background: radial-gradient(circle at bottom left, transparent 3px, var(--theme-accent) 3px);
          z-index: 0;
        }
