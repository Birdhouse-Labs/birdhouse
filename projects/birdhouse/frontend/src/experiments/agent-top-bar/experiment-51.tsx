// ABOUTME: Agent top bar experiment - Hollow Ring on Hover
// ABOUTME: Donut indicator transitions to solid color hollow ring on hover to avoid gradient-on-gradient clash
...
export const metadata = {
  id: "51",
  title: "Hollow Ring on Hover",
  description: "Donut indicator transitions to solid color hollow ring on hover to avoid gradient-on-gradient clash",
};
  ...
  const ContextUsageIndicator = () => {
    ...
    return (
      <Tooltip openDelay={0} closeDelay={0}>
        <Tooltip.Trigger as="button" class="flex-shrink-0 relative z-10 group/donut" aria-label="View context usage">
