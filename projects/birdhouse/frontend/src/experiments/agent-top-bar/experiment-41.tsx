// ABOUTME: Agent top bar experiment - Reduced Corner Radius (Match CodeBlock)
// ABOUTME: Experiment 38 with smaller corner radius matching code block containers
...
export const metadata = {
  id: "41",
  title: "Reduced Corner Radius (Match CodeBlock)",
  description: "Experiment 38 with smaller corner radius matching code block containers",
};
  ...
  return (
    <div class="space-y-4">
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          class="px-4 py-1 flex items-center gap-3 hover-subtle-gradient brightness-track relative overflow-hidden group rounded"
          style={{
