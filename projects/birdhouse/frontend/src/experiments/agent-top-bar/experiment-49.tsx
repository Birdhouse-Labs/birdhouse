// ABOUTME: Agent top bar experiment - Context Usage Donut Indicator
// ABOUTME: Adds clickable gradient-filled donut showing context usage with detailed stats popover
...
export const metadata = {
  id: "49",
  title: "Context Usage Donut Indicator",
  description: "Adds clickable gradient-filled donut showing context usage with detailed stats popover",
};
