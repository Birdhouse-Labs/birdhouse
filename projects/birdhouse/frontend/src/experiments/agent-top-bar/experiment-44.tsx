// ABOUTME: Agent top bar experiment - Top Corners Only Rounded
// ABOUTME: Experiment 43 with rounded corners only on top (sharp bottom corners)
...
export const metadata = {
  id: "44",
  title: "Top Corners Only Rounded",
  description: "Experiment 43 with rounded corners only on top (sharp bottom corners)",
};
...
const Experiment44 = () => {
  ...
  return (
    <div class="space-y-4">
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-t overflow-hidden border border-border">
        {/* ============================================
