// ABOUTME: Agent top bar experiment - Condensed + Animated Gradient Angle
// ABOUTME: Compact design (py-1) with rotating gradient angle and mouse-tracking brightness boost
...
export const metadata = {
  id: "23",
  title: "Condensed + Animated Gradient Angle",
  description: "Compact design (py-1) with rotating gradient angle and mouse-tracking brightness boost",
};
  ...
  return (
    <div class="space-y-4">
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          ref={topBarRef}
          class="px-4 py-1 flex items-center gap-3 brightness-track relative overflow-hidden border-b border-border"
          style={{
            animation: isWorking() ? "rotate-gradient 4s linear infinite" : "none",
            background: !isWorking() ? "var(--theme-surface-raised)" : undefined,
            "--bright-x": "-9999px",
            "--bright-y": "-9999px",
          }}
      ...
      <style>{`
        @keyframes rotate-gradient {
          0% { background: linear-gradient(0deg, var(--theme-gradient-from), var(--theme-gradient-to)); }
          25% { background: linear-gradient(90deg, var(--theme-gradient-from), var(--theme-gradient-to)); }
          50% { background: linear-gradient(180deg, var(--theme-gradient-from), var(--theme-gradient-to)); }
          75% { background: linear-gradient(270deg, var(--theme-gradient-from), var(--theme-gradient-to)); }
          100% { background: linear-gradient(360deg, var(--theme-gradient-from), var(--theme-gradient-to)); }
        }
