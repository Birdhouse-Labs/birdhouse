// ABOUTME: Agent top bar experiment - Fixed Border + Subtle Hover
// ABOUTME: Compact (py-1) with fixed-height pulsing gradient border (no layout shift), 50% opacity hover
...
export const metadata = {
  id: "27",
  title: "Fixed Border + Subtle Hover",
  description: "Compact (py-1) with fixed-height pulsing gradient border (no layout shift), 50% opacity hover",
};
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          ...
          style={{
            ...
            // ALWAYS 3px border - no height change!
