// ABOUTME: Agent top bar experiment - Fixed Border Within Padding (Opus)
...
export const metadata = {
  id: "30",
  title: "Fixed Border Within Padding (Opus)",
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          ...
          style={{
            ...
            // Inset box-shadow for borders - doesn't affect layout!
