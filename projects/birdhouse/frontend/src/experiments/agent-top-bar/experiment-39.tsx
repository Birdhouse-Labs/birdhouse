// ABOUTME: Agent top bar experiment - Double Top Border Height
// ABOUTME: Experiment 38 with 6px top border (double thickness) for stronger visual emphasis
...
export const metadata = {
  id: "39",
  title: "Double Top Border Height",
  description: "Experiment 38 with 6px top border (double thickness) for stronger visual emphasis",
};
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          ...
          style={{
            ...
            // Top border doubled from 3px to 6px
            "box-shadow": isWorking()
              ? "inset 0 6px 0 var(--theme-gradient-from), inset 0 -3px 0 var(--theme-gradient-to)"
