// ABOUTME: Agent top bar experiment - Outline Ring Working Indicator
// ABOUTME: Uses outline ring (like input focus) instead of top/bottom borders for working state
...
export const metadata = {
  id: "48",
  title: "Outline Ring Working Indicator",
  description: "Uses outline ring (like input focus) instead of top/bottom borders for working state",
};
