// ABOUTME: Agent top bar experiment - Vertical Bars Connect Top/Bottom
// ABOUTME: Experiment 45 with left/right vertical bars connecting the top and bottom borders
...
export const metadata = {
  id: "47",
  title: "Vertical Bars Connect Top/Bottom",
  description: "Experiment 45 with left/right vertical bars connecting the top and bottom borders",
};
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          ...
          style={{
            ...
            // Complete frame with top, bottom, left, and right inset borders
            "box-shadow": isWorking()
              ? "inset 0 3px 0 var(--theme-gradient-from), inset 0 -3px 0 var(--theme-gradient-to), inset 2px 0 0 var(--theme-gradient-from), inset -2px 0 0 var(--theme-gradient-to)"
