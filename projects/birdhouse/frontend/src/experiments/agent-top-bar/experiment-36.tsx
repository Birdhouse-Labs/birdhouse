// ABOUTME: Agent top bar experiment - Inside Corner Crescents (Tiny Divs)
// ABOUTME: Two small positioned divs with border-radius create crescent fills at top inside corners
...
export const metadata = {
  id: "36",
  title: "Inside Corner Crescents (Tiny Divs)",
  description: "Two small positioned divs with border-radius create crescent fills at top inside corners",
};
    ...
    <div class="space-y-4">
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        >
          ...
          {/* Crescent fillers - only show when working */}
          <Show when={isWorking()}>
            {/* Top-left crescent */}
            <span
              class="absolute w-2 h-2 rounded-br-full"
              style={{
                top: "3px",
                left: "3px",
            ...
            {/* Top-right crescent */}
            <span
              class="absolute w-2 h-2 rounded-bl-full"
              style={{
                top: "3px",
                right: "3px",
                background: "var(--theme-accent)",
