// ABOUTME: Agent top bar experiment - Top Corners Only (Match CodeBlock)
// ABOUTME: Experiment 41 with corner radius applied only to top of bar
...
export const metadata = {
  id: "45",
  title: "Top Corners Only (Match CodeBlock)",
  description: "Experiment 41 with corner radius applied only to top of bar",
};
