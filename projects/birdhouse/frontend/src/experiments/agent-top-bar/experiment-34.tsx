// ABOUTME: Agent top bar experiment - Gradient Text + Smart Corner Borders
// ABOUTME: Gradient text (like #18) with inset borders on all 4 sides using accent color for perfect corners
...
export const metadata = {
  id: "34",
  title: "Gradient Text + Smart Corner Borders",
  description: "Gradient text (like #18) with inset borders on all 4 sides using accent color for perfect corners",
};
