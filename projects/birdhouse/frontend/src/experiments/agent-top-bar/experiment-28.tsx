// ABOUTME: Agent top bar experiment - Bottom Border Only + Subtle Hover
// ABOUTME: Compact (py-1) with pulsing gradient bottom border only, 50% opacity hover
...
export const metadata = {
  id: "28",
  title: "Bottom Border Only + Subtle Hover",
  description: "Compact (py-1) with pulsing gradient bottom border only, 50% opacity hover",
};
  ...
  return (
    <div class="space-y-4">
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          ref={topBarRef}
          class="px-4 py-1 flex items-center gap-3 hover-subtle-gradient brightness-track relative"
          style={{
            background: "var(--theme-surface-raised)",
            "border-bottom": "3px solid",
            "border-color": isWorking() ? "transparent" : "var(--theme-border)",
      ...
      <style>{`
        /* Border pulse animation for working state */
        ...
        /* Subtle gradient hover background (50% opacity) - LOCKED from Experiment 24 */
