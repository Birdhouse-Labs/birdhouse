// ABOUTME: Agent top bar experiment - Gradient Text + All Borders
// ABOUTME: Gradient text (like #18) with inset borders on all 4 sides, 50% opacity hover
...
export const metadata = {
  id: "33",
  title: "Gradient Text + All Borders",
  description: "Gradient text (like #18) with inset borders on all 4 sides, 50% opacity hover",
};
      ...
      <div class="flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        ...
        <div
          ...
          style={{
            ...
            // Vertical borders added to all 4 sides
            "box-shadow": isWorking()
              ? "inset 0 3px 0 var(--theme-gradient-from), inset 0 -3px 0 var(--theme-gradient-to), inset 3px 0 0 var(--theme-gradient-from), inset -3px 0 0 var(--theme-gradient-to)"
