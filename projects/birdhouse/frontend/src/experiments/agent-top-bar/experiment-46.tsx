// ABOUTME: Agent top bar experiment - Vertical Side Bars Extension
// ABOUTME: Experiment 45 with vertical bars extending down left and right sides
...
export const metadata = {
  id: "46",
  title: "Vertical Side Bars Extension",
  description: "Experiment 45 with vertical bars extending down left and right sides",
};
...
const Experiment46 = () => {
  ...
  return (
    <div class="space-y-4">
      ...
      <div class="relative flex flex-col h-[600px] bg-surface-raised rounded-lg overflow-hidden border border-border">
        {/* ============================================
            LEFT VERTICAL BAR
            ============================================ */}
        {/* biome-ignore lint/a11y/noStaticElementInteractions: Mouse tracking requires div for proper event handling */}
        <div
          class="absolute left-0 top-0 bottom-0 w-[10px] hover-subtle-gradient brightness-track group overflow-hidden"
          style={{
            background: "var(--theme-surface-raised)",
            "box-shadow": isWorking()
              ? "inset 3px 0 0 var(--theme-gradient-from), inset -3px 0 0 var(--theme-gradient-to)"
        ...
        {/* biome-ignore lint/a11y/noStaticElementInteractions: Mouse tracking requires div for proper event handling */}
        <div
          class="absolute right-0 top-0 bottom-0 w-[10px] hover-subtle-gradient brightness-track group overflow-hidden"
          style={{
            background: "var(--theme-surface-raised)",
            "box-shadow": isWorking()
              ? "inset 3px 0 0 var(--theme-gradient-from), inset -3px 0 0 var(--theme-gradient-to)"
        ...
        {/* biome-ignore lint/a11y/noStaticElementInteractions: Mouse tracking requires div for proper event handling */}
        <div
          class="px-4 py-1 flex items-center gap-3 hover-subtle-gradient brightness-track relative overflow-hidden group rounded-t"
          style={{
            background: "var(--theme-surface-raised)",
