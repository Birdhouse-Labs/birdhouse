...
import { fetchGroupWithPatterns, revealPatternGroup } from "../services/pattern-library-api";
...
const GroupView: Component<GroupViewProps> = (props) => {
  ...
  const handleReveal = async () => {
    setIsRevealing(true);
    try {
      await revealPatternGroup(props.groupId);
    } catch (_error) {
      // Silently handle error - UI feedback provided via loading state
    } finally {
                ...
                <div class="flex-1">
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      ...
                      class="text-text-muted hover:text-accent transition-colors disabled:opacity-50"
