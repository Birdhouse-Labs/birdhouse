// ABOUTME: Confirmation dialog for removing AI provider API keys
// ABOUTME: Simple dialog with provider name and remove/cancel actions
...
const ProviderDeleteDialog: Component<ProviderDeleteDialogProps> = (props) => {
  const handleConfirm = () => {
    props.onConfirm();
  };
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content class="fixed left-1/2 top-1/2 z-50 w-full max-w-md rounded-2xl p-6 border shadow-2xl -translate-x-1/2 -translate-y-1/2 bg-surface-raised border-border">
          <div class="flex items-center justify-between mb-2">
            <Dialog.Label class="text-2xl font-bold text-heading">Remove {props.providerName}?</Dialog.Label>
          ...
          <Dialog.Description class="mb-6 text-text-secondary">
            This will delete the API key for {props.providerName}. You can add it again later if needed.
          </Dialog.Description>
