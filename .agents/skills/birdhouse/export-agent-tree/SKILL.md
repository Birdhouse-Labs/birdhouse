---
name: export-agent-tree
description: Export complete agent trees to markdown with clickable links and structured transcripts. Use when you need to export agent tree, export full tree, export tree to markdown, export all agents, or export entire tree.
tags:
  - birdhouse
version: 1.0.0
...
Exports a complete agent tree into a single markdown file with clickable Birdhouse links, tree structure, and emoji-separated agent transcripts in depth-first order.
